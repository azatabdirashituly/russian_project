...
app.post('/getRespFromCultural', async (req, res) => {
    const response = await openai.chat.completions.create({
        ...
        Анализируй ответы определи основные факторы, которые повышают или снижают мотивацию к изучению русского языка. и дай советы для улучшения, поднятие мотиваций к изучению русского языка        `}],
    })
